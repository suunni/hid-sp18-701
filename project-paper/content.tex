...
\section{Steps}
Create the model for identifying the red, yellow and green signals using python and opencv\cite{www-opencv} .
Create cloudmesh command extension for identifying the signal in a given picture.
